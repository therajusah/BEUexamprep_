            ...
            <div className="container px-4 md:px-6">
              ...
              <div className="max-w-3xl space-y-6">
                <p className="text-lg text-muted-foreground">
                  At BEUexamprep, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy outlines how we collect, use, and safeguard your data when you use our website and services.
                </p>
                ...
                <ul className="list-disc list-inside text-lg text-muted-foreground space-y-2">
                  ...
                  <li>Educational information (e.g., university, course of study)</li>
                  <li>Usage data and preferences</li>
                  <li>Communications with BEUexamprep</li>
                </ul>
                ...
                <ul className="list-disc list-inside text-lg text-muted-foreground space-y-2">
                  ...
                  <li>Personalize your experience on BEUexamprep</li>
