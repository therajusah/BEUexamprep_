...
export function NavBar({ className }: NavBarProps) {
  ...
  return (
    <>
      {/* Mobile Header Bar with Logo and Menu */}
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-white/90 dark:bg-background/90 backdrop-blur-lg border-b border-gray-200 dark:border-border shadow-sm">
        <div className="flex items-center justify-between px-4 py-3">
          <Link href="/" onClick={() => handleItemClick('Home')} className="flex items-center">
      ...
      {/* Desktop Navigation */}
      <div className={cn(
        "hidden md:flex fixed top-0 left-1/2 -translate-x-1/2 z-50 pt-6",
        className,
      )}>
